    ...
    return(
        ...
        <div className="container footer__container">
            <a className="footer__logo-link">
                <img src="image/logo.svg" alt="ЛОготип" className="footer___logo"/>
            </a>
            ...
            <div className="footer__info">
                ...
                <ul className="footer__developers">
                    <li className="footer__developer">
                        Designer: <a href="" className="footer_developer-link">Anastasia Ilina</a>
                    </li>
                    <li className="footer__developer">
                        Developer: <a href="" className="footer_developer-link">Taazim Degembaeva</a>
                    </li>
                </ul>
            </div>

            <div className="footer__contacts">
                <a href="mailto:CUPTIME@gmail.com" className="footer_email">CUPTIME@gmail.com</a>
